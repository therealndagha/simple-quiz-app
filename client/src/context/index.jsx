...
const QuizContextProvider = ({children}) =>{
    ...
    return (
        <QuizContext.Provider value={{submitCreateQuizFormData, handleOnChangeCreateQuizFormData, createQuizFormData, config, quizzes, setQuizzes, navigate, currentQuiz, setCurrentQuiz}}>
            {children}
